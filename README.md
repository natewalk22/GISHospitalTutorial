...
5. Inside are 4 layers. Add the layer titled **IllinoisHospitals** to the map.
...
![SelectImage](/Pictures/SelectImage.PNG)
...
![HospitalSelection](/Pictures/HospitalSelection.PNG)
...
![HospitalBuffer](/Pictures/HospitalBuffer.PNG)
10. Click **Run**.
...
![PolygonToRasterHospital](/Pictures/PolygonToRasterHospital.PNG)
...
![ReclassedHospital](/Pictures/ReclassedHospital.PNG)
18. Click **Run**.
...
![InterstateSelection](/Pictures/INTERSTATESELECTION.PNG)
...
![RoadsBuffer](/Pictures/RoadsBuffer.PNG)
...
![RoadsRaster](/Pictures/RoadsRaster.PNG)
...
![RoadsReclass](/Pictures/RoadsReclass.PNG)
...
![ReclassedRoads](/Pictures/ReclassedRoads.PNG)
...
![ReclassedCities.PNG](/Pictures/ReclassedCities.PNG)
...
![AddField](/Pictures/AddField.PNG)
4. Create a new field with the following attributes:
![NewField](/Pictures/NewField.PNG)
...
![CountiesRaster](/Pictures/CountiesRaster.PNG)
...
![CountiesReclass](/Pictures/CountiesReclass.PNG)
13. Remove the **CountiesRaster** from the map, and turn off the **CountiesReclass** layer.
![ReclassedCounties](/Pictures/ReclassedCounties.PNG)
